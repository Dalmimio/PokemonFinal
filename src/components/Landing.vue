<script setup>
import TwPosteos from './twPosteos.vue';
...
<template>
 <main class="d-flex flex-column align-items-center">
  <div class="d-flex flex-column align-items-center header-main">
   ...
   <RouterLink to="/about" class="btn btn-more mt-4">More about us</RouterLink>
  </div>
  <div class="mt-5 d-flex flex-column align-items-center">
    ...
    <RouterLink to="/workwithus" class="btn btn-more mt-4">Work with us</RouterLink>
  </div>
  <div class="mt-5 d-flex flex-column align-items-center">
...
<style scoped>
 ...
 .pokedex{
  margin: 2rem 0;
  width: 280px;
  border-top: 1px solid var(--color-text-ligth);
  border-bottom: 1px solid var(--color-text-ligth);
  padding: 1rem;
 }
 .pokedex img{
  width: 100% !important;
