...
<template>
    <main class="d-flex flex-column align-items-center">
        ...
        <div class=" d-flex flex-column justify-content-between repairs gap-2">
            <h1>Stop there! closed for repairs</h1>
            <h5>We are working to provide you with the best service</h5>

        <img src="https://github.com/Dalmimio/Img-blog/blob/main/sleep.jpg?raw=true" alt="sleep-poke">
        </div>
    </main>
</template>
